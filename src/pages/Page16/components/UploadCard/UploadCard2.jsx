          ...
          <Timeline>
            {
              responseData.map((item, index) => {
                if (index === 1) {
                  return (
                    <TimelineItem title="二次创作" content={item.paintName} time={item.regTime}>
                      <Img src={item.paintUrl} />
                    </TimelineItem>
                  );
                } else if (index === 2) {
                  return (
                    <TimelineItem title="三次创作" content={item.paintName} time={item.regTime}>
                      <div>item.paintName</div>
                    </TimelineItem>
                  );
                }
                return (
                  <TimelineItem title="原创" content={item.paintName} time={item.regTime} state="process">
                    <div>item.paintName</div>
                  </TimelineItem>
                );
              })
